  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Student Candidates</li>
      </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                <thead>
                  ...
                  <th>Firstname</th>
                  <th>Lastname</th>
                  <th>Matriclation. No</th>
                  <th>Candidate College</th>
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, candidates.id AS canid FROM candidates LEFT JOIN positions ON positions.id=candidates.position_id LEFT JOIN voter_college ON voter_college.ID=candidates.candidatecollegeID LEFT JOIN voter_level ON voter_level.ID=candidates.candidatelevelID LEFT JOIN voter_sex ON voter_sex.ID=candidates.candidatesexID LEFT JOIN election_type ON election_type.ID=candidates.election_typeID ORDER BY positions.priority ASC";
