	        	...
	        	<div class="col-sm-10 col-sm-offset-1">
				    ...
				    <?php
				    	...
				    	if($vquery->num_rows > 0){
				    		...
				    		?>
			    			<!-- Voting Ballot -->
						    <form method="POST" id="ballotForm" action="submit_ballot_student_college_election.php">
				        		<?php
									...
									<h3>Welcome, You are registered to vote in Student College Election.</h3>
									</div>';
									while($row = $query->fetch_assoc()){
									$sql1 = "SELECT * FROM candidates WHERE position_id='".$row['id']."' AND election_typeID=3";
